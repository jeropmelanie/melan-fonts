...
> ⚠️ The restore in step 7 only touches Settings, not your photos or files — but any *settings* you changed after making the backup (dark mode, etc.) may revert too. That's expected, not a bug.

> ⚠️ This has only been tested on Samsung (Android 9–13). zFont 3 does list options for other brands, but these are untested — try at your own risk.# melan-fonts
